...
Assim a função $p(x)$ gerada a partir da expansão de Gram-Charlier passa a atender a restrição de positividade e portanto pode ser considerada uma FDP.
$p(x)$ pode ser utilizada para encontrar os estimadores de máxima-verossimilhança para assimetria e curtose.
