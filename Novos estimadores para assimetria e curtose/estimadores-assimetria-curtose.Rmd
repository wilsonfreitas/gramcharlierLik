...
Na sessão anterior demostramos que, para uma região do espaço paramétrico de assimetria e curtose, a expansão de Gram-Charlier, $p(x)$, é atende às restrições para que seja caracterizada como uma FDP.
...
```{r, fig.show='hold', echo=FALSE, cache=TRUE, fig.height=2.5}
theme_set(theme_bw(base_size = 9))
