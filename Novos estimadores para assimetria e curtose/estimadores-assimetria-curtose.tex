...
\caption{\label{tab:unnamed-chunk-14}Resultados do cálculo dos estimadores de assimetria e curtose: máxima-verossimilhança e amostral, para a amostra aleatória normal.}
\centering
