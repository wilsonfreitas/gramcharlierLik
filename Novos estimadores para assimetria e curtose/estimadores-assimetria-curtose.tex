...
\NormalTok{parms <-}\StringTok{ }\KeywordTok{uncons_regionD}\NormalTok{(res}\OperatorTok{$}\NormalTok{par[}\DecValTok{1}\NormalTok{], res}\OperatorTok{$}\NormalTok{par[}\DecValTok{2}\NormalTok{])}
\KeywordTok{plot}\NormalTok{(.x, }\KeywordTok{dgramcharlier}\NormalTok{(.x, parms[}\DecValTok{1}\NormalTok{], parms[}\DecValTok{2}\NormalTok{]), }\DataTypeTok{type=}\StringTok{'l'}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{h=}\DecValTok{0}\NormalTok{, }\DataTypeTok{col=}\StringTok{"red"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(.x, }\KeywordTok{dgramcharlier}\NormalTok{(.x, timeDate}\OperatorTok{::}\KeywordTok{skewness}\NormalTok{(x), timeDate}\OperatorTok{::}\KeywordTok{kurtosis}\NormalTok{(x, }\DataTypeTok{method=}\StringTok{'moment'}\NormalTok{)), }\DataTypeTok{type=}\StringTok{'l'}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{h=}\DecValTok{0}\NormalTok{, }\DataTypeTok{col=}\StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{estimadores-assimetria-curtose_files/figure-latex/unnamed-chunk-15-1.pdf}
\includegraphics{estimadores-assimetria-curtose_files/figure-latex/unnamed-chunk-15-2.pdf}
...
\includegraphics{estimadores-assimetria-curtose_files/figure-latex/unnamed-chunk-18-2.pdf}
