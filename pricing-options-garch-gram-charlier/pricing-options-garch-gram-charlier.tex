...
\hypersetup{unicode=true,
            pdftitle={Superfície de Volatilidade GARCH com incrementos Gram-Charlier},
...
\setlength{\droptitle}{-2em}
  \title{Superfície de Volatilidade GARCH com incrementos Gram-Charlier}
...
\begin{figure}
\centering
\includegraphics{pricing-options-garch-gram-charlier_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{figure}
\centering
\includegraphics{pricing-options-garch-gram-charlier_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\begin{figure}
\centering
\includegraphics{pricing-options-garch-gram-charlier_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\begin{figure}
\centering
\includegraphics{pricing-options-garch-gram-charlier_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\begin{figure}
\centering
\includegraphics{pricing-options-garch-gram-charlier_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\begin{figure}
\centering
\includegraphics{pricing-options-garch-gram-charlier_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\begin{figure}
\centering
\includegraphics{pricing-options-garch-gram-charlier_files/figure-latex/unnamed-chunk-18-1.pdf}
